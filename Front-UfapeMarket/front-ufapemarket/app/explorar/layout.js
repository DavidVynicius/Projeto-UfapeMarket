      ...
      <aside className="w-64 bg-surface border-r border-line p-6 flex-col justify-between shrink-0 hidden lg:flex h-screen fixed top-0 left-0 z-50 overflow-y-auto">
        <div className="space-y-6">
          ...
          <nav className="space-y-1">
            ...
            >
              <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 00-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
              Início
            </Link>
            ...
            >
              <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
              Explorar
            </Link>
            ...
            >
              <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
              Favoritos
            </Link>
            ...
            >
              <svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 4.418 9 8z" /></svg>
              Conversas
            </Link>
          </nav>
          ...
          <div className="pt-4 border-t border-line">
            ...
            <nav className="space-y-1">
              <Link href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-ink-soft hover:bg-canvas transition-all">
              ...
              <Link href="/usuarios" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-ink-soft hover:bg-canvas transition-all">
        ...
        <div className="bg-brand-500 text-white p-4 rounded-2xl space-y-1 mt-6 shrink-0">
          ...
          <p className="text-[11px] text-brand-100 leading-tight">para estudantes da UFAPE. 💚</p>
        </div>
      </aside>
        ...
        <header className="bg-surface border-b border-line px-6 py-4 flex items-center justify-between gap-4 sticky top-0 z-40">
          ...
          <div className="flex-1 max-w-lg mx-auto">
            <div className="relative">
              ...
              />
              <svg className="w-4 h-4 absolute left-3.5 top-3 text-ink-faint" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-3 justify-end flex-1 max-w-[250px]">
            ...
            <div 
              ...
              className="w-9 h-9 rounded-full bg-brand-500 text-white font-bold text-sm flex items-center justify-center shadow-sm cursor-pointer border border-brand-600 hover:bg-brand-600 transition-all shrink-0"
            >
              {inicial}
            </div>

            <Link href="/" className="text-xs font-semibold px-3 py-1.5 rounded-full bg-danger-soft text-danger hover:bg-danger/10 transition-all ml-1 shrink-0">
              Sair
            </Link>
          </div>
        </header>
